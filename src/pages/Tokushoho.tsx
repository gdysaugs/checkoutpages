    ...
    <div className="camera-app">
      ...
      <main className="legal-shell">
        <section className="legal-card">
          <h1>特定商取引法に基づく表記</h1>
          <p>
            本表記は、SparkHeartが提供するデジタルサービス（トークン購入・動画生成機能等）に関する取引条件を示すものです。
          </p>

          <div className="legal-table">
            <div className="legal-row">
              <div className="legal-key">販売事業者</div>
              <div className="legal-value">SparkHeart</div>
            </div>
            <div className="legal-row">
            ...
            <div className="legal-row">
              ...
              <div className="legal-value">キャンペーン・無料付与トークン等の条件は、告知なく変更・終了する場合があります</div>
            </div>
          </div>
